...
public class T9UserRole implements Serializable {

    private static final long serialVersionUID = -1005572734;
    ...
    public T9UserRole(T9UserRole value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("T9UserRole (");
