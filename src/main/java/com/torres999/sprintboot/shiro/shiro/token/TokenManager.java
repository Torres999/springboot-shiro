package com.torres999.sprintboot.shiro.shiro.token;
...
public class TokenManager {
     ...
     * @return
     */
    public static T9User getToken() {
        T9User token = (T9User) SecurityUtils.getSubject().getPrincipal();
        return token;
    }
    ...
    public static Integer getUserId() {
        return getToken() == null ? null : getToken().getUserId().intValue();
    }
     ...
     * @return
     */
    public static T9User login(T9User user, Boolean rememberMe) {
    ...
    public static void clearNowUserAuth() {
         ...
         */
//        t9Realm.clearCachedAuthorizationInfo();
        /**
